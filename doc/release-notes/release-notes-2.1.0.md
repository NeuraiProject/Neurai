Neurai Core version *2.1.0* is now available!!
==============

  <https://github.com/NeuraiProject/Neurai/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/NeuraiProject/Neurai/commits/release_2.1.0>
