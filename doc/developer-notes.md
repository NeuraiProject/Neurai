...
Neurai is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Neurai, where everyone uses
...
pay attention to for reviewers of Neurai code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Neurai uses tinyformat, which is type safe. Leave them out to avoid confusion
