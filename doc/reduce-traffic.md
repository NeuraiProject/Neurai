...
By default, neurai-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that neurai's trustless model works best if you are
