...
#ifndef NEURAI_SCRIPT_SCRIPT_H
#define NEURAI_SCRIPT_SCRIPT_H
...
enum opcodetype
{
    ...
    OP_OUTPUTAUTHCOMMITMENT = 0xd5, // NIP-023
...
static const unsigned int MAX_OPCODE = OP_OUTPUTAUTHCOMMITMENT;
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op xna asset, we consider all data after it has data, and not op codes
        // Move the pc to the end of the script
        if (opcode == OP_XNA_ASSET) {
    ...
    /**
     * Pre-version-0.6, Neurai always counted CHECKMULTISIGs
