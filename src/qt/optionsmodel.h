...
#ifndef NEURAI_QT_OPTIONSMODEL_H
#define NEURAI_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Neurai client.
...
#endif // NEURAI_QT_OPTIONSMODEL_H
