...
#ifndef NEURAI_QT_RECEIVECOINSDIALOG_H
#define NEURAI_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of neurais */
...
#endif // NEURAI_QT_RECEIVECOINSDIALOG_H
