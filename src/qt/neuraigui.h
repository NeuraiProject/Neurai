...
#ifndef NEURAI_QT_NEURAIGUI_H
#define NEURAI_QT_NEURAIGUI_H
...
/**
  Neurai GUI main class. This class represents the main window of the Neurai UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NeuraiGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NeuraiGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~NeuraiGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a neurai wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
