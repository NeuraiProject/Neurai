...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<NeuraiAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_neurai-qt -platform xcb      # Linux
//     src/qt/test/test_neurai-qt -platform windows  # Windows
//     src/qt/test/test_neurai-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = NeuraiUnits::formatWithUnit(unit, balance, false, NeuraiUnits::separatorAlways);
    ...
    // Amount input
    NeuraiAmountField* amountInput = receiveCoinsDialog.findChild<NeuraiAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: neurai:")) != -1);
