...
#ifndef NEURAI_QT_GUICONSTANTS_H
#define NEURAI_QT_GUICONSTANTS_H
...
/* NeuraiGUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Neurai"
#define QAPP_ORG_DOMAIN "neurai.org"
#define QAPP_APP_NAME_DEFAULT "Neurai-Qt"
#define QAPP_APP_NAME_TESTNET "Neurai-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://explorer.neurai.org/tx/%s|https://neuraiexplorer.com/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // NEURAI_QT_GUICONSTANTS_H
