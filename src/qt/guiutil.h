...
#ifndef NEURAI_QT_GUIUTIL_H
#define NEURAI_QT_GUIUTIL_H
...
/** Utility functions used by the Neurai Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "neurai:" URI into recipient object, return true on successful parsing
