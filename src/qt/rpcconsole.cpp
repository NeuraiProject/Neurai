...
bool RPCConsole::eventFilter(QObject* obj, QEvent *event)
{
    if(event->type() == QEvent::KeyPress) // Special key handling
    {
        ...
        case Qt::Key_PageDown:
            if(obj == ui->lineEdit)
            {
                QApplication::postEvent(ui->messagesWidget, static_cast<QKeyEvent*>(keyevt->clone()));
                return true;
            }
            break;
        case Qt::Key_Return:
        case Qt::Key_Enter:
            ...
            if(obj == autoCompleter->popup()) {
                QApplication::postEvent(ui->lineEdit, static_cast<QKeyEvent*>(keyevt->clone()));
                return true;
            }
            break;
        default:
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NeuraiGUI::handleRestart()
