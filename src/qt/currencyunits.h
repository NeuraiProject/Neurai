...
#ifndef NEURAI_QT_CURRENCYUNITS_H
#define NEURAI_QT_CURRENCYUNITS_H

#include <QString>
#include <array>

/** Currency unit definitions. Stores basic title and symbol for a xna swap asset,
...
#endif // NEURAI_QT_CURRENCYUNITS_H
