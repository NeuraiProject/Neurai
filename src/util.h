 ...
 */
#ifndef NEURAI_UTIL_H
#define NEURAI_UTIL_H
...
extern const char *const NEURAI_CONF_FILENAME;
extern const char *const NEURAI_PID_FILENAME;
...
{
    std::string s = strprintf("neurai-%s", name);
