// NIP-035 Neurai vendoring of libsodium ref10. Original file:
//   libsodium src/libsodium/crypto_core/ed25519/ref10/ed25519_ref10.c
// Upstream is ISC-licensed (compatible with Neurai's MIT). Only the
// libsodium-private include lines have been redirected; the algorithmic
// code is verbatim. Strict-profile enforcement lives in the wrapper at
// src/crypto/ed25519.cpp, not here.
...
#include "crypto/ed25519/compat.h"
...
// NIP-035 Neurai: fe_25_5 path removed; we always compile the
// radix-2^51 implementation (HAVE_TI_MODE asserted by compat.h).
#include "crypto/ed25519/fe_51/constants.h"
#include "crypto/ed25519/fe_51/fe.h"
...
#include "crypto/ed25519/fe_51/base.h"
    };
...
#include "crypto/ed25519/fe_51/base2.h"
    };
