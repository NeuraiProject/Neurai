...
#ifndef NEURAI_WALLET_WALLETDB_H
#define NEURAI_WALLET_WALLETDB_H
...
public:
    ...
    static const int VERSION_HD_PQ          = 4;  //!< Version with PQ wallet support
    ...
    bool IsPQ() const               { return bUsePQ == true;}
...
#endif // NEURAI_WALLET_WALLETDB_H
