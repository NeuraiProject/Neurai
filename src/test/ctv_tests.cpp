...
static const unsigned int CTV_FLAGS = SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS | SCRIPT_VERIFY_CHECKTEMPLATEVERIFY;
static const unsigned int CTV_FLAGS_DISCOURAGE = CTV_FLAGS | SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS;
static const unsigned int NO_CTV_FLAGS = SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS;
static const unsigned int NO_CTV_FLAGS_DISCOURAGE = NO_CTV_FLAGS | SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS;
