...
//        std::cout << "Failed: Hash is " << hashString << " but should be " << outString << std::endl;
    ...
    BOOST_AUTO_TEST_CASE(sha256_testvectors_test)
    {
        ...
        TestSHA256("As Neurai relies on 80 byte header hashes, we want to have an example for that.",
                   "900d86db701cb5618cb4409cea8e73b90b16c5f53848a8025dd2407b81ca7b41");
