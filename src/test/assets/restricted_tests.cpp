...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler xna tx
        CScript xnaTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut xnaOut(1*COIN, xnaTransfer);
        ...
        mutTxTest1.vout.emplace_back(xnaOut);
        ...
        mutTxTest2.vout.emplace_back(xnaOut);
        ...
        mutTxTest3.vout.emplace_back(xnaOut);
        ...
        mutTxTest4.vout.emplace_back(xnaOut);
        ...
        mutTxTest5.vout.emplace_back(xnaOut);
        ...
        mutTxTest6.vout.emplace_back(xnaOut);
        ...
        mutTxTest7.vout.emplace_back(xnaOut);
        ...
        mutTxTest8.vout.emplace_back(xnaOut);
