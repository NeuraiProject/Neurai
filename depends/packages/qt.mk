...
define $(package)_postprocess_cmds
  ...
  printf '%s\n' \
    ...
    'Version: $($(package)_version)' \
    'Requires: Qt6Core' \
    'Libs: -L$${libdir} -L$${plugindir}/platforms -lqxcb -lQt6XcbQpa -lQt6FbSupport -lQt6InputSupport -lQt6DeviceDiscoverySupport -lQt6Gui -lQt6BundledHarfbuzz -lQt6BundledLibpng -lQt6BundledFreetype -lxcb -lxcb-glx -lxcb-icccm -lxcb-image -lxcb-keysyms -lxcb-randr -lxcb-render -lxcb-render-util -lxcb-shape -lxcb-shm -lxcb-sync -lxcb-xfixes -lxcb-xinerama -lxcb-xinput -lxcb-xkb -lxcb-cursor -lxcb-ewmh -lxcb-util -lxkbcommon -lxkbcommon-x11 -lfontconfig -lfreetype -lexpat -lXau' \
