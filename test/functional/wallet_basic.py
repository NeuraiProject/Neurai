...
class WalletTest(NeuraiTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 XNA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 XNA with subtract fee from amount
        ...
        # Sendmany 10 XNA with subtract fee from amount
