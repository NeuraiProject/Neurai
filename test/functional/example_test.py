...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NeuraiTestFramework
    pass

class ExampleTest(NeuraiTestFramework):
    # Each functional test is a subclass of the NeuraiTestFramework class.
    ...
    def custom_method(self):
        ...
        NeuraiTestFramework class so other tests can use it."""
