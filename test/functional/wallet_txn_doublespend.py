...
class TxnMallTest(NeuraiTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 XNA:
        ...
        # First: use raw transaction API to send 1240 XNA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 XNA coin each
        ...
        # Node0's balance should be starting balance, plus 50XNA for another
        ...
        # Node0's total balance should be starting balance, plus 100XNA for 
