...
import os
import struct
from test_framework.test_framework import NeuraiTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(NeuraiTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that neurai has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("neuraid has not been built with zmq enabled.")
