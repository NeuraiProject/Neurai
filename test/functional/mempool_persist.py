...
By default, neuraid will dump mempool on shutdown and
...
class MempoolPersistTest(NeuraiTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give neuraid a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent neuraid from writing mempool.dat to disk. Verify that `savemempool` fails")
