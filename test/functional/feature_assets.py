...
class AssetTest(NeuraiTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("NEURAI1", 1000)
        n0.issue("NEURAI2", 1000)
        n0.issue("NEURAI3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="NEURAI*", verbose=False, count=2, start=-2)
        ...
        neurai_assets = n0.listassets(asset="NEURAI*", verbose=False, count=2, start=-2)
        assert_equal(len(neurai_assets), 2)
        assert_equal(neurai_assets[0], "NEURAI2")
        assert_equal(neurai_assets[1], "NEURAI3")
        self.sync_all()
