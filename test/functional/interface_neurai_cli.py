...
class TestNeuraiCli(NeuraiTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `neurai-cli getinfo`")
        ...
        self.log.info("Compare responses from `neurai-cli -getinfo` and the RPCs data is retrieved from.")
