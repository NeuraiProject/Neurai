...
CONFIG_GUESS_URL='https://raw.githubusercontent.com/NeuraiProject/berkeley-db-4.8.30/main/config.guess'
CONFIG_GUESS_HASH='2d1ff7bca773d2ec3c6217118129220fa72d8adda67c7d2bf79994b3129232c1'
CONFIG_SUB_URL='https://raw.githubusercontent.com/NeuraiProject/berkeley-db-4.8.30/main/config.sub'
...
echo 'When compiling Neurai, run `./configure` in the following way:'
echo
