...
find ${DISTNAME}/bin -type f -executable -exec ../neurai/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../neurai/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/neurai/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/neurai/depends/SDKs/MacOSX10.11.sdk.tar.gz
